    ...
    else if(publisherProxy->topicType == "geometry_msgs/msg/Point")
    {
        auto pub = boost::any_cast< std::shared_ptr< rclcpp::Publisher<geometry_msgs::msg::Point> > >(publisherProxy->publisher);
        geometry_msgs::msg::Point msg;
        read__geometry_msgs__msg__Point(in->_.stackID, &msg, &(publisherProxy->rd_opt));
        pub->publish(msg);
    }
    else if(publisherProxy->topicType == "geometry_msgs/msg/Pose")
    {
        auto pub = boost::any_cast< std::shared_ptr< rclcpp::Publisher<geometry_msgs::msg::Pose> > >(publisherProxy->publisher);
        geometry_msgs::msg::Pose msg;
        read__geometry_msgs__msg__Pose(in->_.stackID, &msg, &(publisherProxy->rd_opt));
        pub->publish(msg);
    }
    else if(publisherProxy->topicType == "geometry_msgs/msg/PoseWithCovariance")
    {
        auto pub = boost::any_cast< std::shared_ptr< rclcpp::Publisher<geometry_msgs::msg::PoseWithCovariance> > >(publisherProxy->publisher);
        geometry_msgs::msg::PoseWithCovariance msg;
        read__geometry_msgs__msg__PoseWithCovariance(in->_.stackID, &msg, &(publisherProxy->rd_opt));
        pub->publish(msg);
    }
    ...
    else if(publisherProxy->topicType == "geometry_msgs/msg/Twist")
    {
        auto pub = boost::any_cast< std::shared_ptr< rclcpp::Publisher<geometry_msgs::msg::Twist> > >(publisherProxy->publisher);
        geometry_msgs::msg::Twist msg;
        read__geometry_msgs__msg__Twist(in->_.stackID, &msg, &(publisherProxy->rd_opt));
        pub->publish(msg);
    }
    else if(publisherProxy->topicType == "geometry_msgs/msg/TwistWithCovariance")
    {
        auto pub = boost::any_cast< std::shared_ptr< rclcpp::Publisher<geometry_msgs::msg::TwistWithCovariance> > >(publisherProxy->publisher);
        geometry_msgs::msg::TwistWithCovariance msg;
        read__geometry_msgs__msg__TwistWithCovariance(in->_.stackID, &msg, &(publisherProxy->rd_opt));
        pub->publish(msg);
    }
    ...
    else if(publisherProxy->topicType == "nav_msgs/msg/Odometry")
    {
        auto pub = boost::any_cast< std::shared_ptr< rclcpp::Publisher<nav_msgs::msg::Odometry> > >(publisherProxy->publisher);
        nav_msgs::msg::Odometry msg;
        read__nav_msgs__msg__Odometry(in->_.stackID, &msg, &(publisherProxy->rd_opt));
        pub->publish(msg);
    }
    ...
    else if(publisherProxy->topicType == "sensor_msgs/msg/LaserScan")
    {
        auto pub = boost::any_cast< std::shared_ptr< rclcpp::Publisher<sensor_msgs::msg::LaserScan> > >(publisherProxy->publisher);
        sensor_msgs::msg::LaserScan msg;
        read__sensor_msgs__msg__LaserScan(in->_.stackID, &msg, &(publisherProxy->rd_opt));
        pub->publish(msg);
    }
    ...
    else if(publisherProxy->topicType == "sensor_msgs/msg/Range")
    {
        auto pub = boost::any_cast< std::shared_ptr< rclcpp::Publisher<sensor_msgs::msg::Range> > >(publisherProxy->publisher);
        sensor_msgs::msg::Range msg;
        read__sensor_msgs__msg__Range(in->_.stackID, &msg, &(publisherProxy->rd_opt));
        pub->publish(msg);
    }

...
void write__geometry_msgs__msg__Point(const geometry_msgs::msg::Point& msg, int stack, const ROS2WriteOptions *opt = NULL);
void read__geometry_msgs__msg__Point(int stack, geometry_msgs::msg::Point *msg, const ROS2ReadOptions *opt = NULL);
void write__geometry_msgs__msg__Pose(const geometry_msgs::msg::Pose& msg, int stack, const ROS2WriteOptions *opt = NULL);
void read__geometry_msgs__msg__Pose(int stack, geometry_msgs::msg::Pose *msg, const ROS2ReadOptions *opt = NULL);
void write__geometry_msgs__msg__PoseWithCovariance(const geometry_msgs::msg::PoseWithCovariance& msg, int stack, const ROS2WriteOptions *opt = NULL);
void read__geometry_msgs__msg__PoseWithCovariance(int stack, geometry_msgs::msg::PoseWithCovariance *msg, const ROS2ReadOptions *opt = NULL);
...
void write__geometry_msgs__msg__Twist(const geometry_msgs::msg::Twist& msg, int stack, const ROS2WriteOptions *opt = NULL);
void read__geometry_msgs__msg__Twist(int stack, geometry_msgs::msg::Twist *msg, const ROS2ReadOptions *opt = NULL);
void write__geometry_msgs__msg__TwistWithCovariance(const geometry_msgs::msg::TwistWithCovariance& msg, int stack, const ROS2WriteOptions *opt = NULL);
void read__geometry_msgs__msg__TwistWithCovariance(int stack, geometry_msgs::msg::TwistWithCovariance *msg, const ROS2ReadOptions *opt = NULL);
...
void write__nav_msgs__msg__Odometry(const nav_msgs::msg::Odometry& msg, int stack, const ROS2WriteOptions *opt = NULL);
void read__nav_msgs__msg__Odometry(int stack, nav_msgs::msg::Odometry *msg, const ROS2ReadOptions *opt = NULL);
...
void write__sensor_msgs__msg__LaserScan(const sensor_msgs::msg::LaserScan& msg, int stack, const ROS2WriteOptions *opt = NULL);
void read__sensor_msgs__msg__LaserScan(int stack, sensor_msgs::msg::LaserScan *msg, const ROS2ReadOptions *opt = NULL);
...
void write__sensor_msgs__msg__Range(const sensor_msgs::msg::Range& msg, int stack, const ROS2WriteOptions *opt = NULL);
void read__sensor_msgs__msg__Range(int stack, sensor_msgs::msg::Range *msg, const ROS2ReadOptions *opt = NULL);
